...
| 4 | Ebenezer (WIZ_CRYPTION handshake, LZF packets, game logic) | in progress — socket layer, login/char flow, GAMESTART, region world (4.1–4.4), AISocket link/NPC mirror sync (4.5) and the combat slice (4.6: WIZ_ATTACK, PvP damage formulas, exp/level/loyalty/gold, durability, AI combat handlers) done; chat/items/magic and the remaining gameplay slices open |
