...
// Operations
public:
	void UpdateInfo();		// 모든 정보 갱신 Info
	void UpdateUIBaseInfo();			// Base정보 갱신 Info
	void UpdateUIImageInfo();			// Image정보 갱신 Info
	void UpdateUIStringInfo();			// String정보 갱신 Info
	void UpdateUIListInfo();			// List정보 갱신 Info
	void UpdateUIButtonInfo();			// Button정보 갱신 Info
	void UpdateUIEditInfo();			// Edit정보 갱신 Info
	void UpdateUIProgressInfo();		// Progress정보 갱신 Info
	void UpdateUITrackBarInfo();		// Trackbar정보 갱신 Info
	void UpdateUIScrollBarInfo();		// ScrollBar정보 갱신 Info
	void UpdateUIAreaInfo();			// Area정보 갱신 Info
	void UpdateUIIconSlotInfo();		// IconSlot 정보 갱신(리펜트 전용) Info
	void UpdateUIStaticInfo();			// Static 정보 갱신 Info
protected:
	void Resize();			// 화면 구성요소 재배치 Layout
	void SetPropertyListPos(CPropertyList* pList, CPoint& ptWndPos);	// 구성요소 특정위치에 배치하는 함수 Function
public:
// Overrides
