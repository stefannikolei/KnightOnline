...
// 2. Save/Load도 따로 관리합니다. [Korean comment]
//
// 아래 항목들은 위의 항목 외에도 처리해주어야 할 것들입니다. Process
// 1. Render는 모든 UI를 다 그린후 Render해야 합니다.
// 2. MouseProc함수를 호출해줘야 합니다. Function
// 3. Tick함수도 호출해줘야 합니다. Function
//////////////////////////////////////////////////////////////////////
...
protected:
	float	m_fHoverTime;	// 마우스가 한곳에서 정지하여 있는 시간(누적) Time
	bool	m_bSetText;		// 이미 text가 설정되었는가?
	POINT	m_ptCursor;		// 커서의 위치 Position
};
