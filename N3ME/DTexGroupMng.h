...
{
public:
	std::list<CDTexGroup*>	m_Groups;	//그룹 테이터들을 가지고 있는 리스트. [Korean comment]
	CDlgDTexGroupView*		m_pGroupView;	//실제 작업할때 그룹들을 보여주는 창. Window

	DTEXATTR				m_SelectedDTex;	//작업시 그룹창에서 선택한 그룹과 속성. Window
	DTEXTILEATTR			m_SelectedDTexTile;	//작업시 선택한 실제 텍스쳐 타일. Select
